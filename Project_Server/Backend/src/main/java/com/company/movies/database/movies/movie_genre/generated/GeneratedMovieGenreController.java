...
public abstract class GeneratedMovieGenreController {
    
    protected @Autowired MoviesApplication app;
    protected @Autowired MovieGenreManager manager;
    
    @RequestMapping(value = "/movieGenre", method = GET)
    public List<MovieGenre> get(@RequestParam(value = "start", defaultValue = "0") long start,
