...
public abstract class GeneratedGenreController {
    
    protected @Autowired MoviesApplication app;
    protected @Autowired GenreManager manager;
    
    @RequestMapping(value = "/genre", method = GET)
    public List<Genre> get(@RequestParam(value = "start", defaultValue = "0") long start,
